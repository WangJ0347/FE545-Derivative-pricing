...
#ifndef RANDOM_TREE_PROJECT_ARGLIST_H
#define RANDOM_TREE_PROJECT_ARGLIST_H
...
public:
    ...
    void add(const std::string& ArgumentName, unsigned long value);
...
private:
    ...
    std::map<std::string,unsigned long> ULArguments;
...
#endif //RANDOM_TREE_PROJECT_ARGLIST_H
