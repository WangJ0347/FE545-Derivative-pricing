...
void ArgumentList::add(const std::string &ArgumentName, unsigned long value)
{
    addInternal(ArgumentName, value, ULArguments, number);
}
...
{
    return static_cast<unsigned long>(GetArgumentValueInternal(ArgumentName, ULArguments));
}
